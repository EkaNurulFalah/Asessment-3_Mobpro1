...
fun SepatuDialog(
    ...
    var namaSepatu by remember { mutableStateOf("") }
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(brand, namaSepatu) },
                        enabled = brand.isNotEmpty() && namaSepatu.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
